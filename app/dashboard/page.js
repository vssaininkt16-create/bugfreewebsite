      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 pt-20">
          <div className="max-w-4xl mx-auto text-center">
            <Lock className="w-24 h-24 text-primary mx-auto mb-6 animate-float-slow" />

            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Dashboard <span className="text-primary">Coming Soon</span>
            </h1>
            ...
            <div className="glass-card p-8 rounded-lg max-w-2xl mx-auto text-left">
            ...
            <p className="text-muted-foreground mt-8 terminal-text">
